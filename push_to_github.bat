@echo off
set "GIT_DIR="
set "GIT_INSTALL_DIR=%LOCALAPPDATA%\Microsoft\WinGet\Packages\Git.MinGit_Microsoft.Winget.Source_8wekyb3d8bbwe"
set "PATH=%GIT_INSTALL_DIR%\cmd;%GIT_INSTALL_DIR%\mingw64\bin;%PATH%"
